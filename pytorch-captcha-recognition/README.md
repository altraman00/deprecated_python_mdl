...
- 简介：基于CNN训练的一套 "端到端" 的验证码识别模型，使用深度学习+训练数据+大量计算力，纯数字识别率高达 99.99%，数字+字母识别率 96%
...
- 简介：验证码识别比赛code，针对数字，大小写字母能达到97-99%的准确率，也是参考上面项目pytorch-captcha-recognition演变而来
- https://github.com/pprp/captcha.Pytorch


captcha_identify.pytorch

- 简介：基于torch进行验证码识别,基于https://github.com/dee1024/pytorch-captcha-recognition , 识别率达94%
