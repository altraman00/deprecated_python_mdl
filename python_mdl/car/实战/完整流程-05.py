...
def sendFormApplyFunc(my_cookie, img_url, dir_path):
    ...
    while res_1 is False:
        ...
        res_1 = sendFormApply(my_cookie, img_url, dir_path)
    print('提交表单 申请完成')
...
def sendPhoneCodeFunc(my_cookie, phone, img_url, dir_path):
    ...
    while res_1 is False:
        ...
        res_1 = sendPhoneCode(my_cookie, phone, img_url, dir_path)
    print('发送短信 申请完成')
...
if __name__ == '__main__':
    ...
    site_cookie = "JSESSIONID=A550517988D8DC12C5817E3AA6158F30; arraycookie=wangban2"

    # print('==========================================《第一步》==========================================')
    # # 1、发送表单申请
    # sendFormApplyFunc(site_cookie, img_url, dir_path)
    #
    # print('==========================================《第二步》==========================================')
    # # 2、发送短信的验证码
